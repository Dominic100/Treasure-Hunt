...
public class GroundHopEnemyChase : MonoBehaviour {
    ...
    public float MoveSpeed {
        ...
        set { moveSpeed = Mathf.Max(1f, value); }
    }

    public float HopDuration {
        get { return hopDuration; }
        set { hopDuration = Mathf.Max(value, 2f); }
    }
    ...
    void Update() {
        ...
        // Safety check - if enemy has wandered too far from spawn, jump back
